 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ph="FirebaseError";class It extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Ph,Object.setPrototypeOf(this,It.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,xn.prototype.create)}}class xn{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?Oh(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new It(s,a,r)}}function Oh(t,e){return t.replace(kh,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const kh=/\{\$([^}]+)}/g;function Dh(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function fr(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],o=e[s];if(ro(i)&&ro(o)){if(!fr(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function ro(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dr=new Map,Is=new Map;function Pp(t,e){try{t.container.addComponent(e)}catch(n){Mt.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Pn(t){const e=t.name;if(Is.has(e))return Mt.debug(`There were multiple attempts to register component ${e}.`),!1;Is.set(e,t);for(const n of dr.values())Pp(n,t);return!0}function qa(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Np="firebase-heartbeat-database",Mp=1,On="firebase-heartbeat-store";let Zr=null;function Ja(){return Zr||(Zr=Qh(Np,Mp,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(On)}}}).catch(t=>{throw mt.create("idb-open",{originalErrorMessage:t.message})})),Zr}async function xp(t){try{return(await Ja()).transaction(On).objectStore(On).get(Ya(t))}catch(e){if(e instanceof It)Mt.warn(e.message);else{const n=mt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Mt.warn(n.message)}}}async function co(t,e){try{const r=(await Ja()).transaction(On,"readwrite");return await r.objectStore(On).put(e,Ya(t)),r.done}catch(n){if(n instanceof It)Mt.warn(n.message);else{const r=mt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Mt.warn(r.message)}}}function Ya(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _g(t,e){return Mr(t,"POST","/v1/accounts:signInWithPassword",Nr(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vg(t,e){return Mr(t,"POST","/v1/accounts:signInWithEmailLink",Nr(t,e))}async function bg(t,e){return Mr(t,"POST","/v1/accounts:signInWithEmailLink",Nr(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tm={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Rm=500,Sm=600,Cm="_blank",Am="http://localhost";class To{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Pm(t,e,n,r=Rm,s=Sm){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const c=Object.assign(Object.assign({},Tm),{width:r.toString(),height:s.toString(),top:i,left:o}),u=ge().toLowerCase();n&&(a=ic(u)?Cm:n),sc(u)&&(e=e||Am,c.scrollbars="yes");const f=Object.entries(c).reduce((p,[v,S])=>`${p}${v}=${S},`,"");if(cg(u)&&a!=="_self")return Om(e||"",a),new To(null);const h=window.open(e||"",a,f);L(h,t,"popup-blocked");try{h.focus()}catch{}return new To(h)}function Om(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Um(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function $m(t){Pn(new nn("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),{apiKey:i,authDomain:o}=r.options;return((a,c)=>{L(i&&!i.includes(":"),"invalid-api-key",{appName:a.name}),L(!(o!=null&&o.includes(":")),"argument-error",{appName:a.name});const u={apiKey:i,authDomain:o,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:fc(t)},f=new dg(a,c,u);return zp(f,n),f})(r,s)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Pn(new nn("auth-internal",e=>{const n=Lr(e.getProvider("auth").getImmediate());return(r=>new Lm(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Gt(So,Co,Um(t)),Gt(So,Co,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fm=5*60,Bm=Wa("authIdTokenMaxAge")||Fm;let Ao=null;const Hm=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Bm)return;const s=n==null?void 0:n.token;Ao!==s&&(Ao=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function jm(t=Dp()){const e=qa(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Vp(t,{popupRedirectResolver:xm,persistence:[Vg,Dg,bc]}),r=Wa("authTokenSyncURL");if(r){const i=Hm(r);Ag(n,i,()=>i(n.currentUser)),Cg(n,o=>i(o))}const s=yh("auth");return s&&hg(n,`http://${s}`),n}$m("Browser");const Wm=t=>(Rr("data-v-6dbdceff"),t=t(),Sr(),t),Vm={class:"login-box"},zm=Wm(()=>N("h2",null,"Login",-1)),Km={class:"form-group"},qm={class:"form-group"},Gm=["onClick"],Jm={key:0,class:"error-message"},Ym=bt({__name:"LoginForm",setup(t){const e=Xn(""),n=Xn(""),r={"auth/email-already-in-use":"Diese E-Mail-Adresse ist bereits registriert.","auth/user-not-found":"Diese E-Mail-Adresse ist nicht registriert.","auth/wrong-password":"Das eingegebene Passwort ist falsch.","auth/invalid-email":"Die E-Mail-Adresse ist ungültig.","auth/weak-password":"Das Passwort muss mindestens 6 Zeichen lang sein."};let s=Xn("");const i=()=>{s.value="";const a=jm();Sg(a,e.value,n.value).then(c=>{s.value="",console.log("Successfullly signed in!"),console.log(a.currentUser),Ts.push("/editor")}).catch(c=>{console.log(c),s.value=r[c.code]||"Es ist ein Fehler aufgetreten."})},o=()=>{Ts.push({path:"/",hash:"#coppyright"})};return(a,c)=>(Ie(),Le("div",Vm,[zm,N("form",null,[N("div",Km,[vi(N("input",{id:"email",type:"text",placeholder:"E-Mail","onUpdate:modelValue":c[0]||(c[0]=u=>e.value=u),required:""},null,512),[[Ui,e.value]])]),N("div",qm,[vi(N("input",{id:"password",type:"password",placeholder:"Passwort","onUpdate:modelValue":c[1]||(c[1]=u=>n.value=u),required:""},null,512),[[Ui,n.value]])]),N("p",null,[N("button",{type:"submit",onClick:Gu(i,["prevent"])},"Login",8,Gm)])]),Qe(s)?(Ie(),Le("div",Jm,Nc(Qe(s)),1)):gu("",!0),N("div",{onClick:c[2]||(c[2]=u=>o())},"toCoppyright on mainpage")]))}});const Xm=yt(Ym,[["__scopeId","data-v-6dbdceff"]]),Qm=bt({__name:"LoginView",setup(t){return(e,n)=>(Ie(),Le("main",null,[j(Xm)]))}}),Zm={},e_=N("h1",null,"HIER NUR MIT LOGIN",-1),t_=[e_];function n_(t,e){return Ie(),Le("main",null,t_)}const r_=yt(Zm,[["render",n_]]),Ts=ed({history:_f("/PaddyNowiProject/"),routes:[{path:"/",name:"home",component:dh},{path:"/login",name:"login",component:Qm},{path:"/editor",name:"editor",component:r_},{path:"/about",name:"about",component:()=>id(()=>import("./AboutView-5424b2e5.js"),["assets/AboutView-5424b2e5.js","assets/AboutView-4d995ba2.css"])}]});var s_="firebase",i_="9.17.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
